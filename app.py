...
def upload():
    ...
    if file and allowed_file(file.filename):
        ...
        return render_template('index.html', err='Image is missing!')
...
def uploaded_file(filename):
    ...
    return render_template("result.html", imgsrc=("/"+filename))

@app.route('/saveimage/<imgsrc>')
def saveimage(imgsrc):
    return send_from_directory(app.config['UPLOAD_FOLDER'], imgsrc)
